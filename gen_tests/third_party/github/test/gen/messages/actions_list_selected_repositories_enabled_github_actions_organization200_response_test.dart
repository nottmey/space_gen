...
void main() {
  group('ActionsListSelectedRepositoriesEnabledGithubActionsOrganization200Response', () {
    test('round-trips via maybeFromJson/toJson', () {
      final instance = ActionsListSelectedRepositoriesEnabledGithubActionsOrganization200Response(
        totalCount: 0,
      ...
      final parsed =
          ActionsListSelectedRepositoriesEnabledGithubActionsOrganization200Response.maybeFromJson(
            instance.toJson(),
          )!;
